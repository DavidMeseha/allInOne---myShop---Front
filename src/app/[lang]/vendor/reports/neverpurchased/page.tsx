...
import {
  NeverPurchasedAdvancedSearchOverlay,
  NeverPurchasedAdvancedSearch
} from "../../components/NeverPurchasedAdvancedSearch";
...
export default function NeverPurchasedPage() {
  ...
  return (
    <>
      <div className="hidden md:block">
        <NeverPurchasedAdvancedSearch confirm={confirmSearch} onChange={searchChangeHandle} />
      </div>
      ...
      {isAdvancedSearchOpen ? (
        <NeverPurchasedAdvancedSearchOverlay confirm={confirmSearch} onChange={searchChangeHandle} />
      ) : null}
    </>
  );
}
