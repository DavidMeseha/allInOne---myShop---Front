...
import {
  BestSallersAdvancedSearch,
  BestSallersAdvancedSearchOverlay
} from "../../components/BestSallersAdvancedSearch";
  ...
  return (
    <>
      <div className="hidden md:block">
        <BestSallersAdvancedSearch confirm={confirmSearch} onChange={searchChangeHandle} />
      </div>
      ...
      {isAdvancedSearchOpen ? (
        <BestSallersAdvancedSearchOverlay confirm={confirmSearch} onChange={searchChangeHandle} />
      ) : null}
    </>
  );
}
